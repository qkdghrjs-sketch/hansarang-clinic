...
const INTRO_SERVICES = [
  ...
  { icon: "🔬", color: "#f59e0b", title: "최신 장비", desc: "내시경, 초음파, 임상병리 장비를 도입하여 정밀한 진단이 가능합니다." },
...
const PROGRAMS = [
  ...
  },
  {
    ...
    items: [
      ...
      "종양(암)표지자: 간, 대장, 췌장/담도, 전립선(남)/난소(여)",
      "A,B,C 형 간염검사", "종합판정", "영양상담",
      "심전도검사", "안저촬영", "흉부 X-RAY", "복부 X-RAY", "골밀도검사", "폐기능검사", "복부초음파",
