...
const OUTPATIENT = [
  ...
  { name: "김영진", am: [1, 1, 1, 0, 0, 1], pm: [1, 1, 0, 1, 0, 0] },
  { name: "장윤정", am: [0, 1, 0, 1, 1, 0], pm: [0, 0, 1, 1, 0, 0] },
  { name: "최영균", am: [1, 0, 1, 1, 0, 0], pm: [0, 1, 1, 0, 1, 0] },
  { name: "김수지", am: [0, 0, 1, 1, 1, 0], pm: [0, 1, 1, 0, 1, 0] },
  { name: "박상운", am: [0, 1, 1, 0, 1, 1], pm: [1, 0, 0, 1, 1, 0] },
];
...
const FEATURES = [
  ...
  { title: "풍부한 경험의 의료진이 있습니다.", desc: "대학병원 외래교수 출신의 7명의 전문의가 진료를 담당하여 대학병원에 가지 않고도 편리하게 대학병원 수준의 진료를 받으실 수 있습니다." },
